                                ...
                                <ul class="accordion-box">
                                    ...
                                    <li class="accordion block">
                                        ...
                                        <div class="acc-content">
                                            <div class="content">
                                                <div class="text">We give a Guarantee for a Period of 5 years and
                                                    promise to rectify any fault arising out of faulty workmanship
                                                    at our cost. However the guarantee does not hold good for
                                                    mishandling and breakable. Foresee the pains and troublers thats
                                                    ut are bound to ensue; and equall blamed seds belongs to those
                                                    duty you a complete account of the system.</div>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="accordion block active-block">
                                        <div class="acc-btn active">What is the procedure for getting phone
                                            unlocked? <div class="icon la la-arrow-circle-o-right"></div>
                                        </div>
