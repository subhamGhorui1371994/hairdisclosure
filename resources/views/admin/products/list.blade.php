...
@section('content')
    ...
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title text-bold">Products</h3>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#portfolioList').DataTable({
                ...
                pageLength: 10,
                ajax: {
                    url: base_url + '/admin/products/get-list',
                    type: 'POST',
                ...
                columns: [
                    ...
                    {title: 'Created', data: 'created_at', className: 'text-center'},
                    {
                        ...
                        mRender: function (data, type, row) {
                              return '<a href="' + base_url + '/admin/products/' + row.id + '" style="margin-right: 1.5rem"><i class="icon-eye"></i></a>';
                ...
                initComplete: function (settings, json) {
                    ...
                    $('#portfolioList tbody').on('click', 'tr td .delete-action', function (e) {
                        ...
                        bootbox.confirm('Are you sure you want to delete this notice?',
                            function (result) {
                                if (result === true) {
                                    window.location.href = base_url + '/admin/products/delete/' + delete_id;
                                }
                            },
                        );
                    });
