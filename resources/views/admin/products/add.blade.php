...
@section('content')
    ...
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title text-bold">Add Products</h3>
            <div class="heading-elements">
                <a href="{{ url('admin/products') }}" class="btn btn-primary">List Products</a>
            </div>
        </div>
        <div class="panel-body">

            {!! Form::open(['url' => 'admin/products','role' => 'form', 'class'=>'form-vertical', 'id' => 'notice_form','files' => true ]) !!}
            ...
            <div class="form-group">
                <label class="control-label text-bold" for="banner_image">Products Banner Image</label>
