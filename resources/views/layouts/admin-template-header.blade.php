...
<div class="navbar navbar-inverse">
    <div class="navbar-header">
        <a class="navbar-brand text-uppercase text-bold"
            href="{!! URL::to('/') !!}">{{ config('app.name', 'APP_NAME') }}</a>{{-- express-modify: 1.change .env file app-name, 2.chenge this file optional app-name --}}
